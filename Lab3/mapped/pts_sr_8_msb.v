...
module flex_pts_sr_NUM_BITS8_SHIFT_MSB1 ( clk, n_rst, shift_enable, 
  ...
  DFFSR \current_reg[0]  ( .D(n35), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        current[0]) );
  DFFSR \current_reg[1]  ( .D(n34), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        current[1]) );
  DFFSR \current_reg[2]  ( .D(n33), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        current[2]) );
  DFFSR \current_reg[3]  ( .D(n32), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        current[3]) );
  DFFSR \current_reg[4]  ( .D(n31), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        current[4]) );
  DFFSR \current_reg[5]  ( .D(n30), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        current[5]) );
  DFFSR \current_reg[6]  ( .D(n29), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        current[6]) );
  DFFSR \current_reg[7]  ( .D(n28), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        serial_out) );
  NAND2X1 U11 ( .A(n9), .B(n10), .Y(n35) );
  INVX1 U12 ( .A(n11), .Y(n10) );
  MUX2X1 U13 ( .B(parallel_in[0]), .A(current[0]), .S(n12), .Y(n9) );
  OAI21X1 U14 ( .A(n13), .B(n14), .C(n15), .Y(n34) );
  AOI22X1 U15 ( .A(n11), .B(current[0]), .C(current[1]), .D(n12), .Y(n15) );
  INVX1 U16 ( .A(parallel_in[1]), .Y(n14) );
  OAI21X1 U17 ( .A(n13), .B(n16), .C(n17), .Y(n33) );
  AOI22X1 U18 ( .A(current[1]), .B(n11), .C(current[2]), .D(n12), .Y(n17) );
  INVX1 U19 ( .A(parallel_in[2]), .Y(n16) );
  OAI21X1 U20 ( .A(n13), .B(n18), .C(n19), .Y(n32) );
  AOI22X1 U21 ( .A(current[2]), .B(n11), .C(current[3]), .D(n12), .Y(n19) );
  INVX1 U22 ( .A(parallel_in[3]), .Y(n18) );
  OAI21X1 U23 ( .A(n13), .B(n20), .C(n21), .Y(n31) );
  AOI22X1 U24 ( .A(current[3]), .B(n11), .C(current[4]), .D(n12), .Y(n21) );
  INVX1 U25 ( .A(parallel_in[4]), .Y(n20) );
  OAI21X1 U26 ( .A(n13), .B(n22), .C(n23), .Y(n30) );
  AOI22X1 U27 ( .A(current[4]), .B(n11), .C(current[5]), .D(n12), .Y(n23) );
  INVX1 U28 ( .A(parallel_in[5]), .Y(n22) );
  OAI21X1 U29 ( .A(n13), .B(n24), .C(n25), .Y(n29) );
  AOI22X1 U30 ( .A(current[5]), .B(n11), .C(current[6]), .D(n12), .Y(n25) );
  INVX1 U31 ( .A(parallel_in[6]), .Y(n24) );
  OAI21X1 U32 ( .A(n13), .B(n26), .C(n27), .Y(n28) );
  AOI22X1 U33 ( .A(current[6]), .B(n11), .C(serial_out), .D(n12), .Y(n27) );
