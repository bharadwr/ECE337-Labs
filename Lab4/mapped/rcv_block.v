...
module flex_stp_sr_NUM_BITS9_SHIFT_MSB0 ( clk, n_rst, shift_enable, serial_in, 
  ...
  wire   n22, n23, n24, n25, n26, n27, n28, n29, n30, n10, n11, n12, n13, n14,
         n15, n16, n17, n18, n19;

  DFFSR \parallel_out_reg[8]  ( .D(n30), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        parallel_out[8]) );
  DFFSR \parallel_out_reg[7]  ( .D(n29), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        parallel_out[7]) );
  DFFSR \parallel_out_reg[6]  ( .D(n28), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        parallel_out[6]) );
  DFFSR \parallel_out_reg[5]  ( .D(n27), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        parallel_out[5]) );
  DFFSR \parallel_out_reg[4]  ( .D(n26), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        parallel_out[4]) );
  ...
  DFFSR \parallel_out_reg[1]  ( .D(n23), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        parallel_out[1]) );
  DFFSR \parallel_out_reg[0]  ( .D(n22), .CLK(clk), .R(1'b1), .S(n_rst), .Q(
        parallel_out[0]) );
  INVX1 U11 ( .A(n10), .Y(n30) );
  MUX2X1 U12 ( .B(parallel_out[8]), .A(serial_in), .S(n11), .Y(n10) );
  INVX1 U13 ( .A(n12), .Y(n29) );
  MUX2X1 U14 ( .B(parallel_out[7]), .A(parallel_out[8]), .S(n11), .Y(n12) );
  INVX1 U15 ( .A(n13), .Y(n28) );
  MUX2X1 U16 ( .B(parallel_out[6]), .A(parallel_out[7]), .S(n11), .Y(n13) );
  INVX1 U17 ( .A(n14), .Y(n27) );
  MUX2X1 U18 ( .B(parallel_out[5]), .A(parallel_out[6]), .S(n11), .Y(n14) );
  INVX1 U19 ( .A(n15), .Y(n26) );
  MUX2X1 U20 ( .B(parallel_out[4]), .A(parallel_out[5]), .S(n11), .Y(n15) );
  INVX1 U21 ( .A(n16), .Y(n25) );
  MUX2X1 U22 ( .B(parallel_out[3]), .A(parallel_out[4]), .S(n11), .Y(n16) );
  INVX1 U23 ( .A(n17), .Y(n24) );
  MUX2X1 U24 ( .B(parallel_out[2]), .A(parallel_out[3]), .S(n11), .Y(n17) );
  INVX1 U25 ( .A(n18), .Y(n23) );
  MUX2X1 U26 ( .B(parallel_out[1]), .A(parallel_out[2]), .S(n11), .Y(n18) );
  INVX1 U27 ( .A(n19), .Y(n22) );
  MUX2X1 U28 ( .B(parallel_out[0]), .A(parallel_out[1]), .S(n11), .Y(n19) );
  AND2X1 U29 ( .A(shift_enable), .B(n_rst), .Y(n11) );
endmodule
...
module flex_counter_NUM_CNT_BITS4_1 ( clk, n_rst, rollover_flag, clear, 
...
module flex_counter_NUM_CNT_BITS4_0 ( clk, n_rst, rollover_flag, clear, 
        count_enable, rollover_val, count_out );
  input [3:0] rollover_val;
  output [3:0] count_out;
  input clk, n_rst, clear, count_enable;
...
module timer ( clk, n_rst, enable_timer, shift_strobe, packet_done );
  ...
  flex_counter_NUM_CNT_BITS4_1 count_9 ( .clk(clk), .n_rst(n_rst), 
        .rollover_flag(packet_done), .clear(packet_done), .count_enable(
        shift_strobe), .rollover_val({1'b1, 1'b0, 1'b0, 1'b1}) );
  flex_counter_NUM_CNT_BITS4_0 count_10 ( .clk(clk), .n_rst(n_rst), 
        .rollover_flag(shift_strobe), .clear(packet_done), .count_enable(
        delayed_enable_timer), .rollover_val({1'b1, 1'b0, 1'b1, 1'b0}) );
endmodule
